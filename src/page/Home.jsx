    ...
    return (
        <section className=''>
            <div className='landing grid place-content-center text-center pt-44 flex-wrap'>
                <div
                    id='border-container'
                    className='border-b-2 border-yanami-200 pb-3 sm:pb-5'
                >
                    <h1 className='text-2xl sm:text-4xl font-bold'>
                        Hello,{' '}
                        <span className='before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-komari-200 relative inline-block'>
                            <span className='relative text-yanami-150'>
                                Visitor
                            </span>
                        </span>
                        <br />
                ...
                <p className='font-mono text-komari-200 text-xs sm:text-base px-11 pb-5 pt-3 sm:pb-8 sm:pt-5'>
                    Hello! oh is the name confusing?
                    <span className='text-yanami-200'>
                        {' '}
                        are you interested to know who i am?
                    </span>
                    <br />
                    <span className='text-lemon-100'>
